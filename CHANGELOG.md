...
- added "mushroomAutoGrowLightlevel" config option to adjust the auto grow lightlevel of mushrooms on "extendedmushrooms:mushroom_growing_blocks" blocks (default: 12) (thanks to Aceplante for the idea) #92
...
## [1.20.1-4.1.3.2] - 2024-10-20
### Fixed
- fixed crash and inconsistencies when adding items to Fairy Ring via hoppers (thanks to coolbot100s for the report) #89

## [1.20.1-4.1.3.1] - 2024-05-24
### Fixed
- fixed crash when trying to create a new world (introduced with config option in 1.20.1-4.1.2.0)
...
## [1.20.1-4.1.0.1] - 2023-11-04
### Changed
- Updated compat with Moonlight Lib to 1.20-2.8.54

### Fixed
- Every Compat/Moonlight Lib wood blocks were not available (thanks to Zartrix for the report & MehVahdJukaar for the support fixing the issue) #81 
