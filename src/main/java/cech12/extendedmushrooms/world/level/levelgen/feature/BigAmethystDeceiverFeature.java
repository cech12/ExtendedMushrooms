...
public class BigAmethystDeceiverFeature extends SplitBigMushroomFeature {

    public BigAmethystDeceiverFeature(Codec<ExtendedMushroomFeatureConfiguration> config) {
        super(config);
    }
