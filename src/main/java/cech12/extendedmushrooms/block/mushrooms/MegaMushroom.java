...
public abstract class MegaMushroom extends BigMushroom {
    ...
    protected boolean growMegaMushroom(IWorld world, ChunkGenerator<?> chunkGenerator, BlockPos blockPos, BlockState blockState, Random random, int x, int z) {
        ...
        if (feature == null) {
            ...
            if (feature.place(world, chunkGenerator, random, blockPos.add(x, 0, z))) {
                return true;
            } else {
