...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> STRIPPED_MUSHROOM_STEM = registerBlock("mushroom_stripped_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.MUSHROOM, Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(0.2F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> GLOWSHROOM_STEM = registerBlock("glowshroom_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.GLOWSHROOM, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 8)));
    public static final RegistryObject<Block> GLOWSHROOM_STEM_STRIPPED = registerBlock("glowshroom_stripped_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.GLOWSHROOM, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 8)));
    ...
    public static final RegistryObject<Block> POISONOUS_MUSHROOM_STEM = registerBlock("poisonous_mushroom_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.POISONOUS_MUSHROOM, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> POISONOUS_MUSHROOM_STEM_STRIPPED = registerBlock("poisonous_mushroom_stripped_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.POISONOUS_MUSHROOM, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> HONEY_FUNGUS_STEM = registerBlock("honey_fungus_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.HONEY_FUNGUS, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> HONEY_FUNGUS_STEM_STRIPPED = registerBlock("honey_fungus_stripped_log", CreativeModeTab.TAB_BUILDING_BLOCKS, () -> new MushroomStemBlock(MushroomWoodType.HONEY_FUNGUS, Block.Properties.of(Material.WOOD).strength(0.2F).sound(SoundType.WOOD)));
