...
public class ModItems {
    ...
    public static final RegistryObject<Item> PARROT_WAXCAP_SIGN = ITEMS.register("parrot_waxcap_sign", () -> new SignItem((new Item.Properties()).stacksTo(16), ModBlocks.PARROT_WAXCAP_STANDING_SIGN.get(), ModBlocks.PARROT_WAXCAP_WALL_SIGN.get()));
    public static final RegistryObject<Item> PARROT_WAXCAP_HANGING_SIGN = ITEMS.register("parrot_waxcap_hanging_sign", () -> new HangingSignItem(ModBlocks.PARROT_WAXCAP_HANGING_SIGN.get(), ModBlocks.PARROT_WAXCAP_WALL_HANGING_SIGN.get(), (new Item.Properties()).stacksTo(16)));
    public static final RegistryObject<Item> HONEY_WAXCAP_SIGN = ITEMS.register("honey_waxcap_sign", () -> new SignItem((new Item.Properties()).stacksTo(16), ModBlocks.HONEY_WAXCAP_STANDING_SIGN.get(), ModBlocks.HONEY_WAXCAP_WALL_SIGN.get()));
    public static final RegistryObject<Item> HONEY_WAXCAP_HANGING_SIGN = ITEMS.register("honey_waxcap_hanging_sign", () -> new HangingSignItem(ModBlocks.HONEY_WAXCAP_HANGING_SIGN.get(), ModBlocks.HONEY_WAXCAP_WALL_HANGING_SIGN.get(), (new Item.Properties()).stacksTo(16)));
