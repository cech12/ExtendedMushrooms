...
public class PlacedFeatureProvider implements DataProvider {
    ...
    public CompletableFuture<?> run(@Nonnull CachedOutput cache) {
        return this.lookupProvider.thenCompose(provider -> {
            ...
            bigMushrooms.add(new BigMushroom("big_deadly_fibrecap", ModFeatures.BIG_DEADLY_FIBRECAP_CONFIGURED, 0.1F));
            ...
            megaMushrooms.add(new BigMushroom("mega_deadly_fibrecap", ModFeatures.MEGA_DEADLY_FIBRECAP_CONFIGURED, 0.02F));
